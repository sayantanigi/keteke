                            ...
                            <div class="tab-pane fade show active" id="address-edit" role="tabpanel">
                                <div class="myaccount-content">
                                    ...
                                    <div class="account-details-form">
                                        <form action="<?= site_url('sellercustomer-add') ?>" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-12 mb-30">
                                                    <label>Email</label>
                                                    <input placeholder="Email" name="frm[user_emailid]" type="email" id="validateEmail">
                                                </div>
                                                <div class="col-lg-6 col-12 mb-30">
                                                    <label>Password</label>
                                                    <input placeholder="Password" name="frm[user_pasword]"
                                                        type="password">
                                                </div>
