    ...
    <div class="hero-slider-wrapper">
        ...
        <?php if (is_array($banners) && count($banners) > 0) {
            ...
            <div class="single-slider-item">
                <div class="hero-slider-item-wrapper hero-slider-item-wrapper--fullwidth hero-slider-item-wrapper--bg-move hero-slider-bg-13" style="background-image: url(<?=base_url()?>assets/images/banner/<?= $banv->image ?>);">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
