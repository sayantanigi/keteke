        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card card-primary">
                    ...
                    <form action="<?= admin_url('products/add/') ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-row row">
                                ...
                                <div class="col-lg-6 col-12" id="subcategoryblock">
                                    <div class="form-group">
                                        <label>Select Sub Category</label>
                                        <select class="form-control" name="frm[prsubmenuId]" id="prsubmenuId"></select>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>Product Name</label>
                                        <input placeholder="Product Name" class="form-control" name="frm[productName]" type="text" required>
                                    </div>
                                </div>
                                <!--  <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Discount %" onkeyup="fetchprice()" name="frm[disc_percent]" value="<?= @$product->disc_percent ?>" id="disc_percent" type="number">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                ...
                                <!--  <div class="col-lg-6 col-12">
                                    <div class="form-group tags-box">
                                        <label>Variants</label>
                                        <input  class="form-control" placeholder="Enter Variants using TAB" name="frm[variants]" type="text" value="<?= @$product->variants ?>"  data-role="tagsinput" class="form-control">
                                    </div>
                                </div> -->
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="files[]" multiple required class="form-control" style="padding: 3px;">
