                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <div class="s-box">
                                ...
                                <div class="s-text">
                                    ...
                                    <div class="s-btn">
                                        <a href="javascript:void(0);" onclick="getreviews('<?= $buslist->id ?>')" role="button"
                                            class="btn js__p_start"><i class="fa fa-commenting"></i> Reviews</a>
                                        <a href="javascript:void(0);" onclick="setvalue('<?= $buslist->id ?>')"
                                            class="btn btn-1 js__p_another_start"><i class="fa fa-comments"></i> Message</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="review_head">
                    <div class="row">
                        <div class="col-lg-5 col-md-12">
                            <h2>Reviews <span><button id="review-add-btn" aria-label="add review"
                                        title="Add Review"></button></span></h2>
                        </div>
                        <div class="col-lg-7 col-md-12 sortpnl">
                            <h2>Sort By:
                                <button aria-label="add review" title="Add Review" onclick="getordreview('new')"
                                    class="btnmodal">Newest</button>
                                <button aria-label="add review" onclick="getordreview('high')" title="Add Review"
                                    class="btnmodal">Highest</button>
                                <button aria-label="add review" onclick="getordreview('low')" title="Add Review"
                                    class="btnmodal">Lowest</button></span>
                            </h2>
                    ...
                    <div id="review-form-container">
                        ...
                        <form id="review-form" action="javascript:void(0)" method="post">
                            ...
                            <div class="fieldset">
                                ...
                                <textarea name="reviewComments" id="reviewComments" cols="20" rows="5"
                                    required=""></textarea>
                            </div>
                    ...
                    <form action="javascript:void(0);" onsubmit="messagesubmit()" id="messageForm" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" id="msgEmail" class="form-control" placeholder="Email"
                                        required="">
                                </div>
                                <div class="form-group">
                                    <input type="text" id="msgphone" class="form-control" placeholder="Phone"
                                        required="">
                                </div>
                                <div class="form-group">
                                    <textarea id="msgmessage" cols="30" rows="7" class="form-control"
