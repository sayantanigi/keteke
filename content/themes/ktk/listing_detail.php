		...
		<div class="bootstrap snippets bootdey">
			<div class="row">
				<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="s-box">
						<div class="s-img">
							<img src="https://www.evideocreations.com/wp-content/uploads/2017/07/vga-1.png"/>
							<span>Category</span>
						</div>
						<div class="s-text">
							<h4>Business Name</h4>
							...
							<p>Phone Number</p>
							<div class="s-btn">
								<a href="" class="btn"><i class="fa fa-commenting"></i> Reviews</a> 
								<a href="javascript:void(0);" class="btn btn-1"><i class="fa fa-comments"></i> Message</a>
							</div>
						</div>
					</div>
				</div>
