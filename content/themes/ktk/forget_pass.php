                    ...
                    <div class="formbox">
                        <div class="login" id="login">
                            ...
                            <form class="animate__animated animate__backInRight"
                                action="<?= site_url('user/sendForgetMail') ?>" method="POST">
                                <h2>Enter Your Email</h2>
                                <p id="forgetext"></p>
                                <div class="form-item">
                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                    <input type="email" id="foremail" name="forgetemail" placeholder="Email"
                                        onblur="return checkemail();" autocomplete="off" required>
                                </div>
