                ...
                <div class="profile-info col-md-9">
                    ...
                    <div class="panel">
                        <div class="panel-body bio-graph-info">
                            ...
                            <form class="dash-form" name="registration_business"
                                action="<?= site_url('list-your-business') ?>" role="form" enctype="multipart/form-data"
                                method="post">
                                ...
                                <div class="dash-form-item-full">
                                    <div class="dash-form-item-half">
                                        ...
                                        <input type="text" name="frm[street_addr]" id="location" value="<?= $loc ?>"
                                            required>
