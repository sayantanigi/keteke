                        ...
                        <div class="panel-body bio-graph-info">
                            ...
                            <form class="dash-form" name="registration_business" action="<?= site_url('list-your-business') ?>" role="form" enctype="multipart/form-data" method="post">
                                ...
                                <div class="dash-form-item-full">
                                    ...
                                    <div class="dash-form-item-half secondhalfbox other_classi">
                                        <b>Mention Classification:<span class="red">&nbsp; *</span></b>
                                        <!-- <input type="text" name="frm[other_classi]" id="other_classi" /> -->
                                        <select name="frm[other_classi]" id="other_classi"></select>
                                    </div>
                                ...
                                <div class="dash-form-item-full">
                                    ...
                                    <div class="dash-form-item-half secondhalfbox">
                                        ...
                                        <input type="text" name="frm[phone]" required maxlength="10" placeholder="Enter phone number">
                                    </div>
                                </div>
                                <div class="dash-form-item-full">
                                    <div class="dash-form-item-half">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn default btn-file">
                                                <span class="browsfle"> Browse Image </span>
