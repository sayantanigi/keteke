            ...
            <div class="row" >
              ...
              <div class="col-sm-12 col-md-12 col-xl-6 col-lg-6 search">
                ...
                <form action="<?=site_url('service-list');?>" method="post" > 
					...
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="50" height="60" viewBox="0 0 122 109">
            ...
            <!-- <div class="home-form formFieldBox"> 
              ...
              <label>Type of business</label>
					    ...
					    <div class="input-group"><i class="fa fa-search"></i>
							...
							<select class="select2 choose-option" data-live-search="true" name="sr_category" required>
