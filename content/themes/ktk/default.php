  ...
  <nav class="mobile-nav animate__animated" id="nav-mobile">
    ...
    <a href="../keteke">
      ...
      <ul class="nirmala-light">
        <a href="<?=site_url('login')?>"><li> Login/Sign up </li></a>
        <a href="<?=site_url('list-your-business')?>"><li> List your business</li></a>
       <a href="<?=site_url('shop')?>"><li> Marketplace </li></a>
      </ul>
    </nav>
    ...
    <footer class="foot">
     ...
     <div class="copyright mirmala-semilight">
      ...
      <a href="<?=site_url('privacy-policy')?>"><span class="nirmala-bold red" > &bull;Privacy Policy</span></a>
