                     ...
                     <ul>
                        <?php if(count($cartItems)>0){
                           ...
                           foreach ($cartItems as $crt) {
                              ...
                              ?>
                              <li><?=$crt["name"]?> X 0<?=$crt["qty"]?> <span>$<?=$crt["subtotal"]?>.00</span></li>
                              <li>Shipping charge <span>$<?=$scharge?>.00</span></li>
                              <?php
                              if($dispricetotal ==""){
                              ...
                              <input name="product_id[]" type="hidden" value="<?php echo $crt['id'];?>" />
                              <input name="prd_price[]" type="hidden" value="<?php echo $crt['price'];?>" />
                              <input name="prd_name[]" value="<?php echo $crt['name'];?>" type="hidden" />
                              <input name="prd_quan[]" value="<?php echo $crt['qty'];?>" type="hidden" />
                           <?php } } ?>
                           <input type="hidden" name="total_paid_price" value="<?=$grtotal?>">

                        </ul>
                        <p>Sub Total(In Discount) <span>$<?=$subtotal?>.00</span></p>
