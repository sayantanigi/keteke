                                ...
                                <div class="myaccount-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-xs-12">
                                            ...
                                            <select class="select-field" id="mcategory"
                                                ...
                                                <?php if (is_array($mproducts) && count($mproducts) > 0) {
                                                    ...
                                                    foreach ($mproducts as $mp) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($mp->status != 1) { ?>
                                                                    <a href="<?= site_url('activeate/' . $mp->productId) ?>"><span class="btn btn-warning btn-xs">Deactive</span></a>
                                                                <?php } else { ?>
                                                                    <a href="<?= site_url('deactiveate/' . $mp->productId) ?>"><span class="btn btn-success btn-xs">Active</span></a>
                                                                <?php } ?>
                                                            </td>
                                                            <td>$<?= $mp->offprice ?></td>
                                                            <td>
                                                                <a href="<?= site_url('view-product/' . $mp->productId) ?>" class="btn btn-warning btn-xs">View</a>
                                                                <a href="<?= site_url('edit-product/' . $mp->productId) ?>" class="btn btn-primary btn-xs">Edit</a>
                                                                <a href="<?= site_url('Deleteproduct/' . $mp->productId) ?>" class="btn btn-danger btn-xs delete ml-1">Delete</a>
                                                            </td>
                                                        </tr>
                                                    <?php }
                                                } ?>
