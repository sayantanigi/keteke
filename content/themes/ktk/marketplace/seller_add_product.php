          ...
          <div class="tab-pane fade show active" id="address-edit" role="tabpanel">
            ...
            <div class="myaccount-content">
              ...
              <div class="account-details-form">
                ...
                <form action="<?=site_url('add-product')?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-30">
                      ...
                      <input placeholder="Product Name" name="frm[productName]" type="text">
                    ...
                    <div class="col-lg-6 col-12 mb-30">
                      ...
                      <input placeholder="Product Type" name="frm[product_type]" type="text">
                    ...
                    <div class="col-lg-6 col-12 mb-30">
                      ...
                      <input placeholder="Discount %" onkeyup="fetchprice()" id="disc_percent" name="frm[disc_percent]" type="number">
                    ...
                    <div class="col-lg-6 col-12 mb-30"> 
                     ...
                     <div class="col-lg-6 col-12 mb-30"> 
                      ...
                      <input placeholder="Add unique identifier for the product" name="frm[sku]" type="text" >
                     ...
                     <div class="col-lg-6 col-12 mb-30"> 
                      ...
                      <input placeholder="Collections" name="frm[collections]" type="text"  >
                    ...
                    <div class="col-lg-6 col-12 mb-30">
                      ...
                      <input placeholder="Shipping Charges" name="frm[shipping_charge]" type="text">
                     ...
                     <div class="col-lg-6 col-12 mb-30 tagfullwidth"> 
                      ...
                      <input placeholder="Enter Variants using TAB" name="frm[variants]" type="text"  data-role="tagsinput" class="form-control">
                     ...
                     <div class="col-lg-12 col-12 mb-30"> 
                      ...
                      <input placeholder="SEO Meta Description" name="frm[seo_descr]" type="text">
                    ...
                    <div class="col-lg-12 col-12 mb-30"> 
                      ...
                      <input placeholder="return day" name="frm[return_day]" min="1" type="number">

                    </div>

                    <div class="col-lg-12 col-12 mb-30">

                     <button class="save-change-btn" type="submit">Upload Product</button>
