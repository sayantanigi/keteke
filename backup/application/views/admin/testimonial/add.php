                ...
                <div class="col-sm-10">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea name="frm[description]" class="form-control"><?=$testimonial->description?></textarea>
                    </div>
                  </div>
                </div>
               <div class="col-sm-10">
                  <div class="col-sm-4">
                    <div class="form-group">
                      <img src="<?=site_url('assets/images/testimonial/'.$testimonial->image)?>" onerror="this.src='<?=site_url()?>/assets/images/no-image.png';" class="img-responsive" style="width:100px">
