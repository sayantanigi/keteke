                ...
                <?php
                  ...
                  if(is_array($products) && count($products)>0){
                   ...
                   <td><img src="<?=site_url('assets/images/products/'.@$primg->productImage)?>"  width="80px" onerror="this.src='<?=site_url('assets/images/no-image.png');?>';">
                    <p>prcode: <?=@$products_v->prcode?><br>
                    <?=@$products_v->productName?></p>

                   </td>
                        <td><p>Offer Price:$<?=$products_v->offprice?><br>
                        Actual Price:$<?=$products_v->maxPrice?><br>
                        Disc %: <?=$products_v->disc_percent?></p>
                      </td>
                        <td><?=@$mcatt->name?></td>
                         <td><?=@$products_v->brand_name?></td>
                            <td>
                          <?php
                          if($products_v->prefer_list == 1){
                            ?>
