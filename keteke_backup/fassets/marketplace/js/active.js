(function ($) {
	...
	mainMenuNav.meanmenu({
		...
		meanMenuClose: '<span class="mean-menu-text">Product Category</span> <span class="menu-close"></span>',
		meanMenuOpen: '<span class="mean-menu-text">Product Category</span> <span class="menu-bar"></span>',
