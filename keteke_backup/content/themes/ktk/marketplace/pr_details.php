      ...
      <div class="col-lg-12">
        ...
        <div class="breadcrumb-content">
         <h2>Product Details </h2>
          <ul>
            <li class="has-child"><a href="<?=site_url('shop')?>">Home</a></li>
            <li>Shop</li>
          </ul>
        </div>
            ...
            <div class="small-image-slider-wrapper small-image-slider-wrapper--quickview">
               <div class="ht-slick-slider small-image-slider"
                  ...
                  <div class="small-image-slider-single-item">
                     <img src="<?=site_url('assets/images/products/'.$pimgg->productImage)?>" class="img-fluid" alt="">
                  </div>
               <?php } ?>
            ...
            <div class="product-detail-content">
               ...
               <div class="product-info-block mb-30">
                  ...
                  <div class="single-info">
                     ...
                     <span class="value"><a href="#"><?=$prodetail->brand_name?></a></span>
                  </div>
                  <div class="single-info">
                  ...
                  <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                     ...
                     <div class="product-ratting-wrap">
                        <div class="pro-avg-ratting">
                           <h4><?php echo $this->Master_model->productRating($prodetail->productId); ?> <span>(Overall)</span></h4>
                        </div>
                        ...
                        <div class="ratting-form-wrapper fix" id="reviewform">
                           <?php  $userrol=userrole();
                             if($userrol==4){?>
                           <h3>Add your Comments</h3>
                           <p id="msgprrev"></p>
                           <form action="javascript:void(0)" id="pr-reviewform" onsubmit="productreviewsubmit()"  method="post">
                              <div class="ratting-form row">
                                 ...
                                 <div class="col-md-6 col-12 mb-15">
                                    ...
                                    <input type="hidden" id="rvproductid" value="<?=$prodetail->productId?>">
