      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="form-row row">
            ...
            <input placeholder="Product Name" class="form-control" name="frm[productName]" type="text">
          </div>
          </div>
          </div>
          <div class="form-row row">
          ...
          <div class="form-row row">
             <div class="col-lg-6 col-12">
              <div class="form-group">
                ...
                <input class="form-control" placeholder="Discount %" onkeyup="fetchprice()" id="disc_percent" name="frm[disc_percent]" value="<?=$product->disc_percent?>" id="disc_percent" type="number">
              </div>
            </div>
             <div class="col-lg-6 col-12">
              <div class="form-group">
