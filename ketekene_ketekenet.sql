...
CREATE TABLE `add_to_cart` (
  `id` int(11) NOT NULL,
  `session_id` longtext COLLATE utf8_unicode_ci,
...
(1, 'KETEKEPR67223d1b3af5030-10-2024', 'guest', 'Sayantan', 'Bhakta', 'sayantan@goigi.in', '8987456321', 'Newtown', 'Kolkata', 'WB', 'India', '700091', 0, 1, '2024-10-30 08:05:15', '2024-10-30 14:05:15');
...
(1, 'guest', 'txn_3QFcXFJjDckR426H0z5qX6p6', 'KETEKEPR67223d1b3af5030-10-2024', 'John Doe', 10, 'succeeded', '2024-10-30 14:06:10');
...
CREATE TABLE `products` (
  ...
  `prcode` text,
  `category` text,
  `prsubmenuId` text COMMENT 'PK of marketplace_submenu',
  `productName` text,
